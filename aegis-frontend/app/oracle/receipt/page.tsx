    ...
    useEffect(() => {
        ...
        if (!token) {
            setResult({
                ...
                goplus: { honeypot: true, sellRestriction: false, proxy: false, verified: false },
                basescan: { hasSource: true, sourceLength: 8240, contractName: 'SuspiciousToken' },
                ai: {
                    obfuscatedTax: true,
                    privilegeEscalation: true,
                    externalCallRisk: false,
                    logicBomb: false,
                    reasoning: 'Hidden 15% sell tax in _transfer(); owner can mint unlimited tokens via unprotected ownerMint()',
                },
                riskCode: 53,
                is_malicious: true,
                verdict: 'BLOCKED',
